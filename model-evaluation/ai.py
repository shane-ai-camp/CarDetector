...
def yolo_save_img(image, class_ids, boxes, labels, confidences, colors, file_path):
    ...
    for i, box in enumerate(boxes):
        ...
        box_coords = (
        (text_offset_x, text_offset_y), (text_offset_x + text_width + 10, text_offset_y - text_height - 10))
...
def yolo_pred_list(image_folder_path, names_file, cfg_file, weight_file, confidence_level=0.5, threshold=0.3,
                   save_image=False):
